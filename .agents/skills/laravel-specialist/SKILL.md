...
For conventions and best practices foundation, see **Laravel Best Practices** skill:
- Architecture & Structure → `laravel-best-practices/rules/arch-*.md`
- Eloquent & Database → `laravel-best-practices/rules/eloquent-*.md`
- Controllers & Routing → `laravel-best-practices/rules/controller-*.md`
- Validation & Requests → `laravel-best-practices/rules/validation-*.md`
- Security → `laravel-best-practices/rules/sec-*.md`
